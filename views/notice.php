...
if( ! isset( $_GET['wplp-dismiss-notice'] ) ) { ?>
    ...
    <div class="wplp-dashboard-notice">
    <a class="wplp-dashboard-notice__dismiss" href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'wplp-dismiss-notice', 'true' ) ) ); ?>"><?php esc_html_e( 'Dismiss', 'woocommerce' ); ?></a>
        ...
        <a class="wplp-dashboard-notice__dismiss" target="_blank" href="<?php echo esc_url( 'https://wpwax.com/product/legal-pages-pro/#single-plugin-pricing-plan' ); ?>"><?php esc_html_e( 'Get Now!', 'legal-pages' ); ?></a>
    </div>
